...
public class DocumentController {
	...
	@RequestMapping(value="/getDocumentByCatIDAndUserID",method=RequestMethod.GET)
	public ResponseList<Document> getDocumentByCatIDAndUserID(@RequestParam("catID") String CatID,@RequestParam("userID") int userID,Paging pagination)
	{
		ArrayList<Document> doc=documentService.getDocumentByCatIDAndUserID(CatID,userID,pagination);
		ResponseList<Document> res=new ResponseList<Document>();
