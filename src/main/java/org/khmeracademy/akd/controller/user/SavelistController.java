...
public class SavelistController {
	...
	public Response insert(@RequestBody SavelistInput list)
	{
		Response res=new Response();
	...
	public Response insertSavelistDetail(@RequestBody SavelistDetailInput list)
	{
		Response res=new Response();
		SavelistDetailInput saveListDetail = new SavelistDetailInput();
		saveListDetail.setSavelistID(list.getSavelistID());
		saveListDetail.setCreatedDate(list.getCreatedDate());
		Document doc = new Document();
		doc.setDocID(list.getDocID());
	...
	public Response insertSavelistOnly(@RequestBody SavelistOnlyInput list)
	{
		Response res=new Response();
		Savelist saveList = new Savelist();
				saveList.setName(list.getName());
				saveList.setCreatedDate(list.getCreatedDate());
				saveList.setStatus(list.getStatus());
				saveList.setRemark(list.getRemark());
//				Document doc = new Document();
//				doc.setDocID(list.getDocID());
				User user = new User();
	...
	public Response update(@RequestBody updateSaveList list)
	{
		Response res=new Response();
