...
public interface CategoryRepository {
	...
	@Insert("INSERT INTO akd_categories (cat_id,name,created_date,remark ,parent_id,status,icon,rang_order,level,cat_img) VALUES(#{catID},#{catName},#{createdDate},#{remark},#{parentID},#{status},#{icon},#{order},#{level},#{catImage})")
